...
COMMANDS = [
    ...
    [sys.executable, str(ROOT / "tests" / "test_task_sampling.py")],
    [sys.executable, str(ROOT / "tests" / "test_relationship_evidence.py")],
    [sys.executable, str(ROOT / "tests" / "test_agent_quality.py")],
    ...
    [sys.executable, str(ROOT / "tests" / "test_answer_locality.py")],
